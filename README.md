...
<img src="https://capsule-render.vercel.app/api?type=soft&color=0:0b0f19,40:0d1b2a,70:1b263b,100:00f2fe&height=200&section=header&text=DATA%20ENGINEERING%20MASTER%20PORTFOLIO%20%E2%9A%A1&fontSize=32&fontColor=ffffff&fontAlignY=36&desc=Enterprise%20SQL%20%7C%20Distributed%20Pipelines%20%7C%20Cloud%20Data%20Warehouses&descAlignY=58&descSize=16&descColor=00f2fe&animation=fadeIn" width="100%" />
...
Welcome to my **Data Engineering Master Portfolio**. This repository serves as a centralized, production-grade showcase of my engineering journey across enterprise database architectures, distributed big data pipelines, and modern cloud analytical data warehouses.
...
| :--- | :--- |
| **Databases & Engines** | `SQL Server` • `PostgreSQL` • `MySQL` • `ANSI SQL` |
| **Programming & Processing** | `Python (OOP)` • `Pandas` • `PySpark` • `Delta Lake` |
| **Cloud Data Warehousing** | `Snowflake` • `dbt (Data Build Tool)` • `AWS S3` • `Azure` |
| **Pipeline & Orchestration** | `Apache Airflow` • `Git / GitHub Actions` • `SSMS` • `VS Code` |
