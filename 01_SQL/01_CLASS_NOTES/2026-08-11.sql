...
-- ❌ Fails: Custid 7 does not exist in Parent Q1 table (conflicted with FOREIGN KEY).
...
-- DELETE FROM Q1 WHERE PKID = 1; -- ❌ Fails if Custid 1 has matching rows in Child Q9 table.\n